...
**Status:** **beta.1 shipped** (`usbasp2-beta.1`). Lab default for Diagnostics Plane; board `usbasp-hiduart-atmega328p`. Dual-truth (EP2 + target UART / oracle) is a **lab method**, not a Windows ISP claim. Dual-column TUI → beta.2. See [USBASP2.md](USBASP2.md), [RELEASE-USBASP2-BETA.md](RELEASE-USBASP2-BETA.md).
