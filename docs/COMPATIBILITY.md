...
Waveform proof for ENABLEPROG at `-B 22` is **closed** on the USBasp2 lab path: [SOFTWARE_SCK.md](SOFTWARE_SCK.md).
...
- software SCK `-B 22/50/250` (32/16/4 kHz): historically ENABLEPROG `0x01` on mega8↔mega8 clone pairs; **closed** for USBasp2 → mega8-on-Nano-PCB (`-B 8`/`-B 22` PASS). Report: [SOFTWARE_SCK.md](SOFTWARE_SCK.md).
